...
export class FriendshipService {
  ...
  sendFriendRequest(usernameOrEmail: string): Observable<FriendshipResponse> {
    ...
    return this.http.post<FriendshipResponse>(`${this.apiUrl}/friendships/request`, payload);
  }
  ...
  getIncomingRequests(): Observable<PendingRequest[]> {
    return this.http.get<PendingRequest[]>(`${this.apiUrl}/friendships/pending/incoming`);
  }
  ...
  getOutgoingRequests(): Observable<PendingRequest[]> {
    return this.http.get<PendingRequest[]>(`${this.apiUrl}/friendships/pending/outgoing`);
  }
  ...
  acceptRequest(friendshipId: string): Observable<FriendshipResponse> {
    return this.http.put<FriendshipResponse>(`${this.apiUrl}/friendships/${friendshipId}/accept`, {});
  }
  ...
  rejectRequest(friendshipId: string): Observable<FriendshipResponse> {
    return this.http.put<FriendshipResponse>(`${this.apiUrl}/friendships/${friendshipId}/reject`, {});
  }
  ...
  getFriendsList(): Observable<Friend[]> {
    return this.http.get<Friend[]>(`${this.apiUrl}/friendships`);
  }
  ...
  removeFriendship(friendshipId: string): Observable<void> {
    return this.http.delete<void>(`${this.apiUrl}/friendships/${friendshipId}`);
  }
