...
-- EN A1 MCQ (4 exercises)
INSERT INTO exercise_mcq (id, target_language, difficulty_level, topic, question_text,
    correct_answer, wrong_option_1, wrong_option_2, wrong_option_3, xp_reward, content_type, created_at)
VALUES
    (gen_random_uuid(), 'EN', 'A1', 'articles', 'I have ___ apple.',
     'an', 'a', 'the', 'some', 10, 'GRAMMAR', NOW());

INSERT INTO exercise_mcq (id, target_language, difficulty_level, topic, question_text,
    correct_answer, wrong_option_1, wrong_option_2, wrong_option_3, xp_reward, content_type, created_at)
VALUES
    (gen_random_uuid(), 'EN', 'A1', 'to_be', 'She ___ a teacher.',
     'is', 'are', 'am', 'be', 10, 'GRAMMAR', NOW());

INSERT INTO exercise_mcq (id, target_language, difficulty_level, topic, question_text,
    correct_answer, wrong_option_1, wrong_option_2, wrong_option_3, xp_reward, content_type, created_at)
VALUES
    (gen_random_uuid(), 'EN', 'A1', 'pronouns', '___ am from Germany.',
     'I', 'He', 'She', 'You', 10, 'GRAMMAR', NOW());

INSERT INTO exercise_mcq (id, target_language, difficulty_level, topic, question_text,
    correct_answer, wrong_option_1, wrong_option_2, wrong_option_3, xp_reward, content_type, created_at)
VALUES
    (gen_random_uuid(), 'EN', 'A1', 'plurals', 'There are three ___ on the table.',
     'books', 'book', 'bookes', 'bookies', 10, 'GRAMMAR', NOW());

-- EN A2 MCQ (4 exercises)
INSERT INTO exercise_mcq (id, target_language, difficulty_level, topic, question_text,
    correct_answer, wrong_option_1, wrong_option_2, wrong_option_3, xp_reward, content_type, created_at)
VALUES
    (gen_random_uuid(), 'EN', 'A2', 'present_continuous', 'Look! The children ___ in the park.',
     'are playing', 'is playing', 'plays', 'play', 15, 'GRAMMAR', NOW());

INSERT INTO exercise_mcq (id, target_language, difficulty_level, topic, question_text,
    correct_answer, wrong_option_1, wrong_option_2, wrong_option_3, xp_reward, content_type, created_at)
VALUES
    (gen_random_uuid(), 'EN', 'A2', 'past_simple', 'Yesterday, I ___ to the cinema.',
     'went', 'go', 'goes', 'going', 15, 'GRAMMAR', NOW());

INSERT INTO exercise_mcq (id, target_language, difficulty_level, topic, question_text,
    correct_answer, wrong_option_1, wrong_option_2, wrong_option_3, xp_reward, content_type, created_at)
VALUES
    (gen_random_uuid(), 'EN', 'A2', 'possessives', 'This is ___ car. It belongs to John.',
     'his', 'her', 'its', 'their', 15, 'GRAMMAR', NOW());

INSERT INTO exercise_mcq (id, target_language, difficulty_level, topic, question_text,
    correct_answer, wrong_option_1, wrong_option_2, wrong_option_3, xp_reward, content_type, created_at)
VALUES
    (gen_random_uuid(), 'EN', 'A2', 'comparatives', 'My house is ___ than yours.',
     'bigger', 'more big', 'big', 'biggest', 15, 'GRAMMAR', NOW());

-- EN B1 MCQ (4 exercises)
INSERT INTO exercise_mcq (id, target_language, difficulty_level, topic, question_text,
    correct_answer, wrong_option_1, wrong_option_2, wrong_option_3, xp_reward, content_type, created_at)
VALUES
    (gen_random_uuid(), 'EN', 'B1', 'present_perfect', 'I ___ never ___ to Japan.',
     'have, been', 'has, been', 'have, went', 'had, been', 20, 'GRAMMAR', NOW());

INSERT INTO exercise_mcq (id, target_language, difficulty_level, topic, question_text,
    correct_answer, wrong_option_1, wrong_option_2, wrong_option_3, xp_reward, content_type, created_at)
VALUES
    (gen_random_uuid(), 'EN', 'B1', 'past_perfect', 'By the time I arrived, they ___ already ___.',
     'had, left', 'have, left', 'has, left', 'were, leaving', 20, 'GRAMMAR', NOW());

INSERT INTO exercise_mcq (id, target_language, difficulty_level, topic, question_text,
    correct_answer, wrong_option_1, wrong_option_2, wrong_option_3, xp_reward, content_type, created_at)
VALUES
    (gen_random_uuid(), 'EN', 'B1', 'relative_clauses', 'The man ___ called you is my uncle.',
     'who', 'which', 'what', 'whom', 20, 'GRAMMAR', NOW());

INSERT INTO exercise_mcq (id, target_language, difficulty_level, topic, question_text,
    correct_answer, wrong_option_1, wrong_option_2, wrong_option_3, xp_reward, content_type, created_at)
VALUES
    (gen_random_uuid(), 'EN', 'B1', 'modals', 'You ___ see a doctor. You look ill.',
     'should', 'would', 'could', 'might', 20, 'GRAMMAR', NOW());

-- EN B2 MCQ (4 exercises)
INSERT INTO exercise_mcq (id, target_language, difficulty_level, topic, question_text,
    correct_answer, wrong_option_1, wrong_option_2, wrong_option_3, xp_reward, content_type, created_at)
VALUES
    (gen_random_uuid(), 'EN', 'B2', 'conditionals', 'If I ___ more money, I ___ travel the world.',
     'had, would', 'have, will', 'had, will', 'have, would', 25, 'GRAMMAR', NOW());

INSERT INTO exercise_mcq (id, target_language, difficulty_level, topic, question_text,
    correct_answer, wrong_option_1, wrong_option_2, wrong_option_3, xp_reward, content_type, created_at)
VALUES
    (gen_random_uuid(), 'EN', 'B2', 'passive_voice', 'The letter ___ by the secretary yesterday.',
     'was written', 'is written', 'wrote', 'has written', 25, 'GRAMMAR', NOW());

INSERT INTO exercise_mcq (id, target_language, difficulty_level, topic, question_text,
    correct_answer, wrong_option_1, wrong_option_2, wrong_option_3, xp_reward, content_type, created_at)
VALUES
    (gen_random_uuid(), 'EN', 'B2', 'reported_speech', 'She said that she ___ tired.',
     'was', 'is', 'be', 'were', 25, 'GRAMMAR', NOW());

INSERT INTO exercise_mcq (id, target_language, difficulty_level, topic, question_text,
    correct_answer, wrong_option_1, wrong_option_2, wrong_option_3, xp_reward, content_type, created_at)
VALUES
    (gen_random_uuid(), 'EN', 'B2', 'wish_clauses', 'I wish I ___ speak French fluently.',
     'could', 'can', 'would', 'will', 25, 'GRAMMAR', NOW());

-- EN C1 MCQ (3 exercises)
INSERT INTO exercise_mcq (id, target_language, difficulty_level, topic, question_text,
    correct_answer, wrong_option_1, wrong_option_2, wrong_option_3, xp_reward, content_type, created_at)
VALUES
    (gen_random_uuid(), 'EN', 'C1', 'subjunctive', 'The manager insisted that he ___ present at the meeting.',
     'be', 'is', 'was', 'were', 30, 'GRAMMAR', NOW());

INSERT INTO exercise_mcq (id, target_language, difficulty_level, topic, question_text,
    correct_answer, wrong_option_1, wrong_option_2, wrong_option_3, xp_reward, content_type, created_at)
VALUES
    (gen_random_uuid(), 'EN', 'C1', 'inversion', 'Not only ___ he late, but he also forgot the documents.',
     'was', 'is', 'did', 'had', 30, 'GRAMMAR', NOW());

INSERT INTO exercise_mcq (id, target_language, difficulty_level, topic, question_text,
    correct_answer, wrong_option_1, wrong_option_2, wrong_option_3, xp_reward, content_type, created_at)
VALUES
    (gen_random_uuid(), 'EN', 'C1', 'cleft_sentences', 'It ___ John who broke the window.',
     'was', 'is', 'were', 'has', 30, 'GRAMMAR', NOW());

-- EN C2 MCQ (3 exercises)
INSERT INTO exercise_mcq (id, target_language, difficulty_level, topic, question_text,
    correct_answer, wrong_option_1, wrong_option_2, wrong_option_3, xp_reward, content_type, created_at)
VALUES
    (gen_random_uuid(), 'EN', 'C2', 'mixed_conditionals', 'If she ___ harder, she ___ a better job now.',
     'had studied, would have', 'studied, will have', 'has studied, would have', 'had studied, will have', 35, 'GRAMMAR', NOW());

INSERT INTO exercise_mcq (id, target_language, difficulty_level, topic, question_text,
    correct_answer, wrong_option_1, wrong_option_2, wrong_option_3, xp_reward, content_type, created_at)
VALUES
    (gen_random_uuid(), 'EN', 'C2', 'ellipsis', 'She can speak French and so ___ I.',
     'can', 'do', 'am', 'have', 35, 'GRAMMAR', NOW());

INSERT INTO exercise_mcq (id, target_language, difficulty_level, topic, question_text,
    correct_answer, wrong_option_1, wrong_option_2, wrong_option_3, xp_reward, content_type, created_at)
VALUES
    (gen_random_uuid(), 'EN', 'C2', 'nominalization', 'The ___ of the project took three months.',
     'completion', 'complete', 'completing', 'completed', 35, 'GRAMMAR', NOW());

-- =====================================================
-- ENGLISH FILL-BLANK GRAMMAR EXERCISES (22 total)
-- =====================================================

-- EN A1 Fill-blank (4 exercises)
...
VALUES
    (gen_random_uuid(), 'EN', 'B1', 'connectors', 'I stayed home ___ I was feeling sick.',
     'because', 20, 'GRAMMAR', NOW());

-- EN B2 Fill-blank (4 exercises)
INSERT INTO exercise_fill_blank (id, target_language, difficulty_level, topic, sentence_with_blank,
    correct_answer, xp_reward, content_type, created_at)
VALUES
...
INSERT INTO exercise_fill_blank (id, target_language, difficulty_level, topic, sentence_with_blank,
    correct_answer, xp_reward, content_type, created_at)
VALUES
    (gen_random_uuid(), 'DE', 'A1', 'haben', 'Sie ___ zwei Kinder.',
     'hat', 10, 'GRAMMAR', NOW());
...
VALUES
    (gen_random_uuid(), 'DE', 'A1', 'verben', 'Du ___ sehr gut Deutsch.',
     'sprichst', 10, 'GRAMMAR', NOW());

-- DE A2 Fill-blank (4 exercises)
INSERT INTO exercise_fill_blank (id, target_language, difficulty_level, topic, sentence_with_blank,
    correct_answer, xp_reward, content_type, created_at)
VALUES
...
VALUES
    (gen_random_uuid(), 'DE', 'C1', 'partizipial', 'Die ___ Aufgabe war sehr schwierig.',
     'gestellte', 30, 'GRAMMAR', NOW());

INSERT INTO exercise_fill_blank (id, target_language, difficulty_level, topic, sentence_with_blank,
    correct_answer, xp_reward, content_type, created_at)
VALUES
    (gen_random_uuid(), 'DE', 'C1', 'futur_ii', 'Bis morgen werde ich die Arbeit ___ haben.',
     'beendet', 30, 'GRAMMAR', NOW());

-- DE C2 Fill-blank (3 exercises)
INSERT INTO exercise_fill_blank (id, target_language, difficulty_level, topic, sentence_with_blank,
    correct_answer, xp_reward, content_type, created_at)
VALUES
